...
"settings":
{
	...
	"email_settings" : 
	{
		...
		"notification_message" : 
		{
			...
			"is_present" : true,
			"replyto" : "",
			"to" : "contacto@drcarlosaguilar.mx"
		}
	},
	"general_settings" : 
	{
	...
	"redirect_settings" : 
	{
		...
		"gotopage" : "http://www.drcarlosaguilar.mx/confirmacion.html",
	...
	"uid" : "50b86fefa93f209e87d57617be9daf72",
	"validation_report" : "in_line"
},
"rules":{"text1":{"label":"Nombre","fieldtype":"text","messages":"Es importante que ingrese su nombre","required":true},"email2":{"email":true,"label":"Email","fieldtype":"email","required":true,"messages":"Es importante que ingrese su email"},"tel4":{"phone":"phoneUS","fieldtype":"tel","label":"Tel&eacute;fono"},"text5":{"label":"Asunto","fieldtype":"text"},"textarea7":{"fieldtype":"textarea","maxlength":"10000","label":"Comentarios","required":true,"messages":"Es importante que escriba un comentario"}},
"payment_rules":{},
"conditional_rules":{},
