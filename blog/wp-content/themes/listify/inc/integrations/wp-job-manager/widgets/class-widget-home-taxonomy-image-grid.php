...
class Listify_Widget_Taxonomy_Image_Grid extends Listify_Widget {
	...
	function widget( $args, $instance ) {
		...
		<div class="row">
			...
			<section id="image-grid-term-<?php echo $term->slug; ?>" class="<?php echo $cols . $spans[$count]; ?> image-grid-item">
				<div <?php echo apply_filters( 'listify_cover', $cols . ' image-grid-cover
				entry-cover', array( 'object_ids' => $cover_objects ) ); ?>>
	...
	private function get_terms() {
		$terms = get_terms( $this->taxonomy, array( 'fields' => 'ids' ) );
