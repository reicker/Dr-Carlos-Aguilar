...
class Listify_WP_Job_Manager_Reviews extends Listify_Integration {
	...
	?>
		<div itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating" class="job_listing-rating-wrapper" title="<?php printf( '%d Reviews', $number ); ?>">
			...
			<span class="job_listing-rating-count">
				<?php printf( _n( '<span itemprop="reviewCount">%1$d</span> Review', '<span
				itemprop="reviewCount">%d</span> Reviews', $number, 'listify' ), $number ); ?>
			</span>
		</div>
	<?php
	}
