...
class Listify_Customizer_Output_Colors {
	...
	public function body_text() {
		...
		$this->css->add( array(
			'selectors' => array(
				...
				'.no-image .ion-ios7-star:before',
				'.no-image .ion-ios7-star-half:before',
				'.back-to-listing a',
				'body .chosen-container-single .chosen-single',
	...
	public function primary() {
		...
		$this->css->add( array(
			'selectors' => array(
				'.listify_widget_panel_listing_tags a.active:before',
	...
	public function accent() {
		...
		$this->css->add( array(
			'selectors' => array(
				...
				'.comment-author .rating-stars .ion-ios7-star',
