    ...
    public function __construct() {
		...
		$this->steps = array(
			...
			'setup-homepage' => array(
				...
				'description' => 
					'<p>' . __( 'In order to display custom widgets on your homepage you must first assign your static page in the WordPress settings. You can also set which page will display your blog posts.', 'listify' ) . '</p>' .
